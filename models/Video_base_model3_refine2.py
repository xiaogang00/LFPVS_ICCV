...
class VideoBaseModel(BaseModel):
    ...
    def optimize_parameters(self, step):
        ...
        self.fake_H, fake_H1 = self.netG(self.var_L, mask, x_gt=self.real_H)

        l_pix = self.l_pix_w * self.cri_pix(self.fake_H, self.real_H)
        l_pix += self.l_pix_w * self.cri_pix(fake_H1, self.real_H)
        l_vgg = self.l_pix_w * self.cri_vgg(fake_H1, self.real_H) * 0.1
